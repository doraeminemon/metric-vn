export function Header() {
  return (
    <div id="header" className='header flex border-b border-b-gray-300 pb-4 px-4 justify-center'>
      <div className="items-center flex max-w-[1240px] w-full">
        <div className=' bg-white py-3 px-4 flex flex-shrink-0 cursor-pointer'>
